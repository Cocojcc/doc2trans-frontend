...
1. **Treating documents as plain text**: structure metadata is lost.
...
1. Upload the source file (PDF/Word/Excel/PPT)
2. Select target languages (multiple at once)
3. Maintain a glossary (brand terms, product names, industry vocabulary)
4. Generate and spot-check key pages (TOC, table-heavy pages)
5. Export and deliver (editable, reusable)
